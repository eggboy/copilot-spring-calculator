...
1. Navigate to the [Copilot-spring-calculator repo](https://github.com/hieumoscow/copilot-spring-calculator) 
...
<img alt="URL for cloning is https://github.com/hieumoscow/copilot-spring-calculator.git" width="400" src="../assets/Cloning the repo.png" />
